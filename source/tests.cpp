...
TEST_CASE("Task 6.5", "") {
  ...
  REQUIRE(c1->pos_.x == Approx(0.0f).epsilon(0.001));
  REQUIRE(c1->pos_.y == Approx(200.0f).epsilon(0.001));
  REQUIRE(c1->pos_.z == Approx(200.0f).epsilon(0.001));
  REQUIRE(c1->front_.x == Approx(0.0f).epsilon(0.001));
  REQUIRE(c1->front_.y == Approx(-0.707f).epsilon(0.001));
  REQUIRE(c1->front_.z == Approx(-0.707f).epsilon(0.001));
  REQUIRE(c1->world_up_.x == Approx(0.0f).epsilon(0.001));
